...
class employee: public personalInfo, public departmentInfo
{
    protected:
        int jnYear;
    public:
        employee(char *pName, int eId, char g, char *dName, char* aw, int jnY): personalInfo(pName, eId, g), departmentInfo(dName, aw){
            jnYear = jnY;
        }
        showEmployeeInfo() {
...
class serverMaintenanceOfficer: public employee
{
    protected:
        int pHS;
    public:
        serverMaintenanceOfficer(char *pName, int eId, char g, char *dName, char* aw, int jnY, int pHS): employee(pName, eId, g, dName, aw, jnY) {
            this->pHS = pHS;
        }
        showEmployeeInfo() {
